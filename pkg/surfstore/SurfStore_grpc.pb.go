...
const (
	...
	RaftSurfstore_MakeServerUnreachableFrom_FullMethodName = "/surfstore.RaftSurfstore/MakeServerUnreachableFrom"
)
...
func (c *raftSurfstoreClient) MakeServerUnreachableFrom(ctx context.Context, in *UnreachableFromServers, opts ...grpc.CallOption) (*Success, error) {
	out := new(Success)
	err := c.cc.Invoke(ctx, RaftSurfstore_MakeServerUnreachableFrom_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _RaftSurfstore_MakeServerUnreachableFrom_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RaftSurfstore_MakeServerUnreachableFrom_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
